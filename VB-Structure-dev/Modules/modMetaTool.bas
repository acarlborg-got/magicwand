...
' ========================================
' modMetaTool – Globala och regelstyrda metadataåtgärder
' ========================================

Option Explicit

' === Applicera samma metadata på alla valda filer ===
...
' === Beräkna värde baserat på källa ===
...
' === Läs värde från dokumentets BuiltInProperty ===
